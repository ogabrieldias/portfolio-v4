...
const skills = [
  ...
  { name: "JavaScript", icon: <i className="devicon-javascript-plain colored" alt="JavaScript"></i> },
  { name: "React", icon: <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg" alt="React" /> },
  { name: "TypeScript", icon: <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/typescript/typescript-original.svg" alt="TypeScript" /> },
  ...
  { name: "Flask", icon: <i className="devicon-flask-plain colored" alt="Flask"></i> },
  ...
  { name: "Supabase", icon: <i className="devicon-supabase-plain colored" alt="Supabase"></i> },
